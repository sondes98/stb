            ...
            <div className="card__side card__side--back card__side--back">
              <div className="card__description">
                ...
                <p className="desc">
                  ...
                  été approuvés. Pour la période 2016-2020, et si l’on se réfère
                  au calcul du levier (Coût total des projets investis/Montant
                  investi), un dinar investi par la STB SICAR en draine en
                  moyenne 8 en termes d’investissement.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card__side card__side--back card__side--back">
              <div className="card__description">
                ...
                <p className="desc">
                  ...
                  ont besoin afin de poursuivre les programmes à distance. La
                  STB SICAR a signé une convention de partenariat avec El
